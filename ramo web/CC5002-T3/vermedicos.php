...
<html lang="es">
	...
	<head>
		...
		<script>
			...
			function loadMedicos() {
			  	...
			  	var value = document.getElementById("rellenamedico").value;
			  	var div = document.getElementById("queried_medicos");
			  	if(value.length < 3){
			  		div.innerHTML = "";
			  		return;
			  	}
			  	...
			  	xhttp.open("GET", `completamedico.php?start=${value}`, true);
			  	xhttp.send();
			}
		</script>
	...
	<body onload="loadMedicos()">

		<a href="index.php">Volver a la página principal</a><br>
		<br>

		<input id="rellenamedico" type="text" oninput="loadMedicos()"><br>

		<div id="queried_medicos"></div><br>
